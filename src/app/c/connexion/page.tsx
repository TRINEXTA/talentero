    ...
    try {
      ...
      if (data.user.role !== 'CLIENT' && data.user.role !== 'ADMIN') {
        toast({
          ...
          description: "Cet espace est réservé aux entreprises",
          variant: "destructive",
        })
        return
      }
      ...
      router.push(data.redirectUrl || '/c/dashboard')
    } catch {
      toast({
        title: "Erreur",
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Connectez-vous pour gérer vos offres et candidatures
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <p className="mt-4 text-center text-sm text-gray-500">
          Vous êtes freelance ?{' '}
          <Link href="/t/connexion" className="text-primary hover:underline">
            Connexion freelance
          </Link>
        </p>
      </div>
